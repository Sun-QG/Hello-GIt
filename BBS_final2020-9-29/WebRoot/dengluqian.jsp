...
<html>
  <head>
	  <meta charset="utf-8">
    <title>论坛</title>
	  <link rel="stylesheet" href="D:\layui\layui-v2.5.6\layui\css\layui.css"  media="all">
    <style>
      body{
        width: 70%;
        margin: 0 auto;
		  ...
		  <div id="tabConent">
			  ...
			  <form action="login.jsp" method="post" id="myform">
				  <p class="on">
					  ...
					  <br>
					  <input type="text" placeholder=" 密码：" style="line-height: 40px;margin-top: 25px;width: 300px;margin-left: 100px;border-radius: 25px" name="pwd">
					  <br>
			  ...
			  <form id="myform2" method="post" action="zhuce.jsp">
				  <p>
					  <input type="text" name="account" placeholder=" 用户名：" style="line-height: 40px;width: 300px;margin-left: 100px;border-radius: 25px;margin-top: 10px">
					  <br>
					  <input type="text" id="mima1" name="pwd" placeholder=" 密码：" style="line-height: 40px;margin-top: 25px;width: 300px;margin-left: 100px;border-radius: 25px">
					  <br>
					  <input type="text" id="mima2" placeholder=" 确认密码：" style="line-height: 40px;margin-top: 25px;width: 300px;margin-left: 100px;border-radius: 25px">
					  <br>
  ...
  <div	style="height: 40px;background-color: #f2eeec">
	  ...
	  <div style="margin-top: 5px">
		  ...
		  %>
		  <span id="top3" style="font-size: 15px;color: #8b2630;margin-left: 800px">
			欢迎：<%=name%>
		  </span>
		  <span >
			  <a href="#" style="font-size: 15px;color: #8c222c;margin-left: 10px;text-decoration: none" onclick="person()">个人中心</a>
		  </span>
		  <span>
			  <a href="#" style="font-size: 15px;color: #8c222c;margin-left: 10px;text-decoration: none" onclick="out()">退出登录</a>
		  </span>
		  <%
			  }
		  %>
...
<%--	  <div class="right-botton indexs" id="right">&gt;</div>--%>
    ...
    <div style="float: left;width: 25%">
        <div class="nav-lunbo-left">
          ...
          <div class="nav-lunbo-left-two nav-lunbo-left-big">
            <div class="boxborder">
              <div>Web前端</div>
              <div class="g clearf">
                <a href="#" style="color:#ff3b00;" id="i8"></a>
                <a href="#">|</a><a href="#"></a>
                <a href="#">|</a><a href="#"></a>
                <a href="#">|</a><a href="#"></a>
                <a href="#">|</a><a href="#"></a>
            ...
            <span class="nav-lunbo-left-two-span" style="top:-10px">

										<div style="margin-left: 30px;">
											<div style="margin-top: 20px;font-size: 20px;color: #8C222C;margin-bottom: 5px;border-bottom: 1px #8C222C solid;">Web前端</div>
											<div >
												<a href="#" class="ziti"></a>
												<a class="ziti">|</a>
												<a href="#" class="ziti"></a>
          ...
          <div class="nav-lunbo-left-two nav-lunbo-left-big">
            <div class="boxborder">
              <div>编程语言</div>
              <div class="g clearf">
                <a href="#" style="color:#ff3b00;" id="i7"></a>
                <a href="#">|</a>
                <a href="#"></a>
                <a href="#">|</a>
                <a href="#"></a>
            ...
            <span class="nav-lunbo-left-two-span" style="top:-50px">
										<div style="margin-left: 30px;">
											<div style="margin-top: 20px;font-size: 20px;color: #8C222C;margin-bottom: 5px;border-bottom: 1px #8C222C solid;">编程语言</div>
											<div >
												<a href="#" class="ziti"></a>
												<a class="ziti">|</a>
												<a href="#" class="ziti"></a>
          ...
          <div class="nav-lunbo-left-two nav-lunbo-left-big">
            <div class="boxborder">
              ...
              <div class="g clearf">
                ...
                <a href="#"></a>
                <a href="#">|</a>
                <a href="#" style="color:#ff3b00;" id="i2"></a>
              </div>
            </div>
            <span class="nav-lunbo-left-two-span" style="top:-200px">
										<div style="margin-left: 30px;">
											<div style="margin-top: 20px;font-size: 20px;color: #8C222C;margin-bottom: 5px;border-bottom: 1px #8C222C solid;">数据库技术</div>
											<div >
												<a href="#" class="ziti"></a>
												<a class="ziti">|</a>
												<a href="#" class="ziti"></a>
          ...
          <div class="nav-lunbo-left-two nav-lunbo-left-big">
            <div class="boxborder">
              <div>操作系统</div>
              <div class="g clearf">
                <a href="#" style="color:#ff3b00;" id="i3"></a>
                <a href="#">|</a>
                <a href="#"></a>
                <a href="#">|</a>
                <a href="#"></a>
            ...
            <span class="nav-lunbo-left-two-span" style="top:-300px">
										<div style="margin-left: 30px;">
											<div style="margin-top: 20px;font-size: 20px;color: #8C222C;margin-bottom: 5px;border-bottom: 1px #8C222C solid;">操作系统</div>
											<div >
												<a href="#" class="ziti"></a>
												<a class="ziti">|</a>
												<a href="#" class="ziti"></a>
          ...
          <div class="nav-lunbo-left-two nav-lunbo-left-big">
            <div class="boxborder">
              ...
              <div class="g clearf">
                <a href="#"></a>
                <a href="#">|</a>
                <a href="#" style="color:#ff3b00;" id="i6"></a>
                <a href="#">|</a>
                <a href="#"></a>
                <a href="#">|</a>
                <a href="#"></a>
            ...
            <span class="nav-lunbo-left-two-span" style="top:-370px">
										<div style="margin-left: 30px;">
											<div style="margin-top: 20px;font-size: 20px;color: #8C222C;margin-bottom: 5px;border-bottom: 1px #8C222C solid;">云计算</div>
											<div >
												<a href="#" class="ziti"></a>
												<a class="ziti">|</a>
												<a href="#" class="ziti"></a>
    	...
    	<div style="float: right;width: 74%;">
			<div style="border: 1px #8c222c solid;height: 300px">
				...
				<div>
					<div style="width: 100px;height: 100px;border: 1px black solid;float: left">
						<a href="#">黑神话吧</a>
					</div>
					<div style="width: 100px;height: 100px;border: 1px black solid;float: right">
						<a href="Section.jsp?y=0&postbar=1">英雄联盟吧</a>
					</div>
			</div>
			<div style="margin-top: 320px;border: 1px #8c222c solid;height: 500px">
				<div style="margin-left: 10px;color: #bf2737">
					热门
				</div>
				<div>
  ...
  <script type="text/javascript">
    ...
    function congqi(){
      dingshiqi=setInterval(function(){
        ...
        for(var i=0;i<imgs.length;i++){
          ...
          botton[i].style.cssText="background-color:rgba(150,150,150,0.5);color:#000;"
        }
        imgs[index].style.cssText="z-index:100;";
        botton[index].style.cssText="background-color:#bebab8;color:#fff;"
      },2000);
    }
    ...
    botton[0].onclick=function(){
      ...
      imgs[index].style.cssText="z-index:100;";
      botton[0].style.cssText="background-color:#bebab8;color:#fff;"
      congqi();
    }
    botton[1].onclick=function(){
      ...
      imgs[index].style.cssText="z-index:100;";
      botton[1].style.cssText="background-color:#bebab8;color:#fff;"
      congqi();
    }
    botton[2].onclick=function(){
      ...
      imgs[index].style.cssText="z-index:100;";
      botton[2].style.cssText="background-color:#bebab8;color:#fff;"
      congqi();
    }
    botton[3].onclick=function(){
      ...
      imgs[index].style.cssText="z-index:100;";
      botton[3].style.cssText="background-color:#bebab8;color:#fff;"
      congqi();
    }
    botton[4].onclick=function(){
      ...
      imgs[index].style.cssText="z-index:100;";
      botton[4].style.cssText="background-color:#bebab8;color:#fff;"
      congqi();
    }
	function x(){
